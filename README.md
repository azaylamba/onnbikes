...
You have to design & build the backend for the application and the ability for the users to register, check rent information and rent bikes.
...
https://github.com/azaylamba/onnbikes
